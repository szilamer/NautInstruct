...
export const missions: NavMission[] = [
  {
    ...
    brief: 'Belvízi hajóút: a jobb oldalt piros, a bal oldalt zöld bója jelzi. Haladj a bóják között, és állj be a kikötőhöz. Kerüld a zátonyt!',
    environment: 'folyo',
    timeOfDay: 'nappal',
    visibility: 'tiszta',
    ...
    buoys: [
      { id: 'r1', x: 3.5, z: 9, keepOn: 'starboard', color: 'red' },
      { id: 'g1', x: -3.5, z: 9, keepOn: 'port', color: 'green' },
      { id: 'r2', x: 3.5, z: 20, keepOn: 'starboard', color: 'red' },
      { id: 'g2', x: -3.5, z: 20, keepOn: 'port', color: 'green' },
      { id: 'r3', x: 3.5, z: 31, keepOn: 'starboard', color: 'red' },
      { id: 'g3', x: -3.5, z: 31, keepOn: 'port', color: 'green' },
    ],
  ...
  },
  {
    id: 'nav-folyo-tilos',
    topicId: 'jelzesek',
    title: 'Folyó védett zónával',
    brief: 'Belvízi hajóút a bóják között (jobb = piros, bal = zöld). Kerüld ki a védett/sekély zónát, és érj a kikötőhöz!',
    environment: 'folyo',
    timeOfDay: 'nappal',
    visibility: 'tiszta',
    start: { x: 0, z: 0, heading: 0, speed: 0 },
    channel: { centerline: [{ x: 0, z: 0 }, { x: 0, z: 40 }], halfWidth: 6 },
    buoys: [
      { id: 'r1', x: 3.5, z: 8, keepOn: 'starboard', color: 'red' },
      { id: 'g1', x: -3.5, z: 8, keepOn: 'port', color: 'green' },
      { id: 'r2', x: 3.5, z: 30, keepOn: 'starboard', color: 'red' },
      { id: 'g2', x: -3.5, z: 30, keepOn: 'port', color: 'green' },
    ],
    zones: [
      { id: 'vedett', x: -2, z: 19, radius: 3, kind: 'no-go', label: 'védett zóna' },
      { id: 'goal', x: 0, z: 40, radius: 3, kind: 'goal', label: 'Kikötő' },
    ],
    vessels: [],
    hazards: [],
    goalZoneId: 'goal',
  ...
  {
    id: 'nav-tenger-zatony',
    topicId: 'navigacio',
    title: 'Zátony kerülése tengeren',
    brief: 'Tengeri szakaszon egy zátonyt kell biztonságosan kikerülnöd, majd elérni a célt. Tartsd a biztonságos távolságot!',
    environment: 'tenger',
    timeOfDay: 'nappal',
    visibility: 'tiszta',
    start: { x: 0, z: 0, heading: 0, speed: 0 },
    ...
    vessels: [],
    hazards: [
      { id: 'zatony1', x: 0, z: 20, radius: 3, label: 'zátony' },
      { id: 'zatony2', x: -5, z: 30, radius: 2, label: 'zátony' },
    ],
    goalZoneId: 'goal',
    violations: {
      'no-go': { ruleId: 'r-akadaly-kerules', diagnosisOptions: diag.hazard },
